        ...
        <main class="main-content">
            ...
            <div class="page active" id="page-home">
                ...
                <div class="metrics-scroll-wrap">
                    <div class="metrics-grid">
                        <div class="metric-card" onclick="navigate('users')">
                            ...
                            <div class="metric-value" id="m-total">248</div>
                        ...
                        <div class="metric-card" onclick="navigate('users')">
                            ...
                            <div class="metric-value" id="m-students">184</div>
                            <div class="metric-sub">+8% active</div>
                        </div>
                        ...
                        <div class="metric-card" onclick="navigate('users')">
                            ...
                            <div class="metric-value" id="m-teachers">18</div>
                            <div class="metric-sub">3 new</div>
                        </div>
                    </div>
                </div>
                ...
                <section class="modules-container">
                    ...
                    <div class="log-item">
                        <div class="log-info">
                            <div class="log-avatar blue-avatar">KV</div>
                            <div>
                    ...
                    <div class="log-item">
                        <div class="log-info">
                            <div class="log-avatar orange-avatar">SY</div>
                            <div>
                                <div class="log-title">System Update Applied</div>
                                <div class="log-meta">Platform updated to v2.4.1 — 5 hours ago</div>
                            </div>
                        </div>
                ...
                <div class="metrics-scroll-wrap">
                    <div class="metrics-grid">
                        <div class="metric-card">
                            <div class="metric-header"><span class="metric-label">Total Users</span>
                                <div class="icon-container blue-theme">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                                </div>
                            </div>
                            <div class="metric-value">248</div><div class="metric-sub">+12 this month</div>
                        </div>
                        <div class="metric-card">
                            ...
                            <div class="metric-value">184</div><div class="metric-sub">74% of total</div>
                        </div>
                        <div class="metric-card">
                            <div class="metric-header"><span class="metric-label">Teachers</span>
                                <div class="icon-container orange-theme">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
                                </div>
                            </div>
                            <div class="metric-value">18</div><div class="metric-sub">7% of total</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="page" id="page-analytics">
                ...
                <div class="metrics-scroll-wrap">
                    <div class="metrics-grid">
                        <div class="metric-card">
                            <div class="metric-header"><span class="metric-label">Daily Active</span>
                                <div class="icon-container green-theme">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                                </div>
                            </div>
                            <div class="metric-value">142</div><div class="metric-sub">↑ 14% vs last week</div>
                        </div>
                        <div class="metric-card">
                            <div class="metric-header"><span class="metric-label">Avg. Score</span>
                                <div class="icon-container purple-theme">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                                </div>
                            </div>
                            <div class="metric-value">78%</div><div class="metric-sub">↑ 3pts improvement</div>
                        </div>
                        <div class="metric-card">
                            <div class="metric-header"><span class="metric-label">Modules Done</span>
                                <div class="icon-container orange-theme">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
                                </div>
                            </div>
                            <div class="metric-value">3.2k</div><div class="metric-sub">this month</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="chart-container">
                    ...
                    <div class="bar-chart" id="reg-chart"></div>
                </div>
            ...
            <div class="page" id="page-content">
                ...
                <div class="modules-container">
                    ...
                    <div class="toolbar">
                        <input type="text" class="search-input" id="content-search" placeholder="🔍  Search modules…" oninput="filterContent()">
            ...
            <div class="page" id="page-activity">
                ...
                <div class="metrics-scroll-wrap">
                    <div class="metrics-grid">
                        <div class="metric-card">
                            <div class="metric-header"><span class="metric-label">Events Today</span>
                                <div class="icon-container blue-theme">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                                </div>
                            </div>
                            <div class="metric-value">37</div><div class="metric-sub">since midnight</div>
                        </div>
                        <div class="metric-card">
                            <div class="metric-header"><span class="metric-label">Logins Today</span>
                                <div class="icon-container green-theme">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>
                                </div>
                            </div>
                            <div class="metric-value">94</div><div class="metric-sub">↑ 8 vs yesterday</div>
                        </div>
                        <div class="metric-card">
                            <div class="metric-header"><span class="metric-label">Errors</span>
                                <div class="icon-container red-theme">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                                </div>
                            </div>
                            <div class="metric-value">2</div><div class="metric-sub">minor warnings</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="page" id="page-settings">
                ...
                <div class="settings-section">
                    ...
                    <div class="field-row"><label>Platform Name</label><input type="text" id="s-platform-name" value="Math Learning Assistant"></div>
                    <div class="field-row"><label>Admin Email</label><input type="email" id="s-admin-email" value="admin@mathlearn.edu"></div>
                    <div class="field-row"><label>Platform Description</label><textarea id="s-desc" rows="3">An AI-powered math learning assistant for students and teachers.</textarea></div>
                    <div class="save-row">
                ...
                <div class="settings-section">
                    ...
                    <div class="save-row">
                        <button class="btn-save" onclick="saveSettings('Roles & Permissions')">Save Roles</button>
                    </div>
                </div>
...
<nav class="bottom-nav">
    ...
    <button class="nav-item" data-page="settings">
        ...
        <span>Settings</span><div class="nav-dot"></div>
    </button>
</nav>
...
<div class="modal-overlay" id="modal-user">
    <div class="modal">
        ...
        <div class="field-row"><label>Full Name</label><input type="text"   id="u-name"   placeholder="e.g. Juan dela Cruz"></div>
        <div class="field-row"><label>Email</label>    <input type="email"  id="u-email"  placeholder="user@example.com"></div>
...
<div class="modal-overlay" id="modal-content">
    <div class="modal">
        ...
        <div class="field-row"><label>Module Title</label><input type="text" id="c-title" placeholder="e.g. Introduction to Algebra"></div>
        ...
        <div class="field-row"><label>Description</label><textarea id="c-desc" rows="3" placeholder="Brief description of this module…"></textarea></div>
        <div class="field-row"><label>Status</label>
...
<!--
    If using Laravel + Vite, replace the two lines above with:
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.js"></script>
    @vite(['resources/js/dashboard/admin_dashboard.js'])
-->
